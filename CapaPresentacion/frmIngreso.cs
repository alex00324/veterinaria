...
namespace CapaPresentacion
{
    public partial class frmIngreso : Form
    {
        ...
        public frmIngreso()
        {
            ...
            this.dtFecha_ingreso.Visible = false;
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if(registrar)
                    {
                        decimal subTotal = Convert.ToDecimal(this.txtStock.Text) * Convert.ToDecimal(Convert.ToInt32(this.txtPrecioCompra.Text) * 1.19);
                        ...
                        row["precio_compra"] = Convert.ToDecimal(Convert.ToInt32(this.txtPrecioCompra.Text) * 1.19);
